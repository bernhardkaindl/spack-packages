...
class Rust(Package):
    ...
    version("1.86.0", sha256="2576f9f440dd99b0151bd28f59aa0ac6102d5c4f3ed4ef8a810c8dd05057250d")
    ...
    depends_on("rust-bootstrap@1.86:1.87", type="build", when="@1.87")
    ...
    # rustc bugs prevent these:
    conflicts("target=aarch64: platform=linux", msg="SIGSEGV/possible stack overflow building py-kornia-rs", when="@1.88:1.89")
    conflicts("target=x86_64: platform=linux", msg="compile fails with cygwin error", when="@1.86.0")
